...
4. **애플리케이션 등록 (API이용신청)** 페이지에서 애플리케이션 등록 세부 정보를 입력한 다음 **등록하기**를 클릭합니다.
...
3. [**비로그인 오픈 API 서비스 환경**](https://developers.naver.com/docs/common/openapiguide/appregister.md#%EB%B9%84%EB%A1%9C%EA%B7%B8%EC%9D%B8-%EC%98%A4%ED%94%88-%EC%95%A1%ED%8B%B0%EB%B9%84%ED%8B%B0-%EC%84%9C%EB%B9%84%EC%8A%A4-%ED%99%98%EA%B2%BD)에서 애플리케이션을 서비스할 환경을 추가하고 필요한 상세 정보를 입력합니다.
